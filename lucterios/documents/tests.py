...
class DocumentTest(LucteriosTest):
    ...
    def test_list(self):
        ...
        self.assert_action_equal('POST', "#document/actions/@0/@1/@1", ('Ajouter', 'mdi:mdi-file-plus-outline', 'lucterios.documents', "documentAddModify", 0, 1, 1))
        self.assert_action_equal('DELETE', "#document/actions/@0/@1/@2", ('Supprimer', 'mdi:mdi-file-remove-outline', 'lucterios.documents', "documentDel", 0, 1, 2))
        self.assert_action_equal('POST', "#document/actions/@0/@1/@3", ('Modifier', 'mdi:mdi-folder-edit', 'lucterios.documents', "folderAddModify", 0, 1, 1, {'folder': 1, 'parent': None}))
        self.assert_action_equal('GET', "#document/actions/@0/@1/@4", ('Back', 'mdi:mdi-folder-arrow-left', 'lucterios.documents', "documentMosaic", 0, 2, 1, {'document': 0}))
        ...
        self.assert_count_equal('document', 0)
        self.assert_count_equal("#document/actions/@0/@1", 5)
        self.assert_action_equal('POST', "#document/actions/@0/@1/@3", ('Modifier', 'mdi:mdi-folder-edit', 'lucterios.documents', "folderAddModify", 0, 1, 1, {'folder': 3, 'parent': 2}))
        self.assert_count_equal("#document/actions/@1/@1", 1)
        self.assert_count_equal("#document/actions/@2/@1", 1)
    ...
    def test_delete(self):
        ...
        self.assert_json_equal('', "document/@0/info", "<b>name</b> doc1.png<br/>\n<b>description</b> doc 1<br/>\n<b>modifier</b> ---<br/>\n<b>date modification</b>", True)
        ...
        self.assert_json_equal('', "document/@1/info", "<b>name</b> truc3<br/>\n<b>description</b> ----<br/>\n<b>modifier</b> ---<br/>\n<b>date modification</b> ---<br/>\n")
