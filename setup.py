# -*- coding: utf-8 -*-
'''
setup module to pip integration of Lucterios documents
...
setup(
    name="lucterios-documents",
    version=__version__,
    author="Lucterios",
    author_email="info@lucterios.org",
    url="http://www.lucterios.org",
    description="documents managment module for Lucterios framework.",
    long_description="""
    ...
    install_requires=["lucterios ==2.4.*", "Pillow ==6.0.*", "etherpad-lite ==0.5.*", "requests"],
)
